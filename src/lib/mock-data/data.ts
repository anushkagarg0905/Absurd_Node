...
export const RECENT_INVESTIGATIONS: InvestigationCard[] = [
  {
    id: 'inv-1',
...
export const MOCK_METRICS: Record<string, DashboardMetrics> = {
  'openai': {
    totalEntities: 14,
  ...
  'microsoft': {
    totalEntities: 18,
    relationshipsFound: 36,
    sourcesAnalyzed: 284,
    confidenceScore: 97,
  },
  'google': {
    totalEntities: 22,
    relationshipsFound: 45,
    sourcesAnalyzed: 412,
    confidenceScore: 95,
  },
  'default': {
...
export const MOCK_AI_SUMMARIES: Record<string, AISummary> = {
  'openai': {
    target: 'OpenAI',
    summary: 'OpenAI is a major research organization and commercial entity in the artificial intelligence space. Founded in 2015 as a non-profit, it restructured into a capped-profit model in 2019 to attract venture capital. Its chief financial backer and close cloud service partner is Microsoft, which holds a significant minority stake.',
    keyInsights: [
  ...
  'microsoft': {
    target: 'Microsoft',
    summary: 'Microsoft Corporation is a multinational technology conglomerate headquartered in Redmond, Washington. The organization has positioned itself as a primary leader in generative AI through its strategic partnership and cloud hosting agreement with OpenAI, integrating advanced LLM capabilities directly into its Azure, Windows, and Office suites.',
    keyInsights: [
  ...
  'google': {
    target: 'Google',
    summary: 'Google LLC (Alphabet Inc.) is an international search and cloud computing company. Google has merged its Google Brain and DeepMind divisions to centralize its generative AI research. Its Gemini model serves as the core foundation for search, workspace integrations, and cloud enterprise services.',
    keyInsights: [
  ...
  'default': {
    ...
    summary: 'AI-generated intelligence summary will appear here after backend integration. A mock investigation has been performed for this entity to simulate the analytical flow.',
    keyInsights: [
...
export const MOCK_ENTITIES: Record<string, OSINTEntity[]> = {
  'openai': [
  ...
  'microsoft': [
    ...
    { id: 'me-8', name: 'GitHub', type: 'Company', description: 'Software development hosting subsidiary', confidenceScore: 99, tags: ['Subsidary', 'Git'] },
    ...
    { id: 'me-10', name: 'LinkedIn', type: 'Company', description: 'Professional networking subsidiary', confidenceScore: 99, tags: ['Subsidary', 'Social'] },
    ...
    { id: 'me-16', name: 'Activision Blizzard', type: 'Company', description: 'Gaming publisher acquired in 2023', confidenceScore: 98, tags: ['Gaming', 'Subsidary'] },
  ...
  'google': [
    ...
    { id: 'ge-8', name: 'Google I/O', type: 'Event', description: 'Annual developer developer conference', confidenceScore: 95 }
  ],
  'default': [
...
export const MOCK_RELATIONSHIPS: Record<string, OSINTRelationship[]> = {
  'openai': [
